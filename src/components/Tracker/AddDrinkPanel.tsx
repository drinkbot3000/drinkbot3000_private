...
export interface AddDrinkPanelProps {
  onAddDrink: (name?: string, oz?: number | null, abv?: number | null) => void;
  savedCustomDrinks: SavedCustomDrink[];
  showCustomDrink: boolean;
  onToggleCustomDrink: () => void;
  customDrinkName: string;
  customDrinkOz: string;
  customDrinkABV: string;
  onCustomDrinkChange: (field: 'name' | 'oz' | 'abv', value: string) => void;
  onAddCustomDrink: () => void;
  onSaveCustomDrink: () => void;
  onDeleteCustomDrink: (id: string) => void;
  onCancelCustomDrink: () => void;
}
...
export function AddDrinkPanel({
  ...
  onDeleteCustomDrink,
  onCancelCustomDrink,
}: AddDrinkPanelProps): JSX.Element {
  return (
